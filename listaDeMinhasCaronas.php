...
<body>
    ...
    <div class="container">
        <div class="text-center">
            <h1>Minhas Caronas Cadastradas</h1>
            <div class="btn-group" role="group">
                <a href="oferecer_carona.php" class="btn btn-primary"> Cadastrar Nova Carona</a>
            </div>
        </div>
        <table class="table">
            <?php include_once("caronas.php");
            $vetcaronas = retornaCaronaPorId($codUsuario);
    ...
    <td>' . $data . '</td> <td>' . $qtd_vagas . '</td> <td>' . 'R$' . $valor_viagem . '</td> <td>' . $nomeOfertante . '</td> <td>' .
                        '<a href="excluirCarona.php?id=' . $codCarona . '" class="btn btn-danger" onclick="return confirm(\'Deseja excluir?\');">Excluir</a></td> </tr>');
                } // fecha foreach
            } // fecha if
            else {
