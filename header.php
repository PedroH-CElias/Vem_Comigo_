      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#"><i class="fa-solid fa-magnifying-glass"></i> Caronas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#"><i class="fa-solid fa-bolt-lightning"></i> Oferecer Carona</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="login.php">SignUp</a></li>
                <li><a class="dropdown-item" href="cadastro.php">SingIn</a></li>
              </ul>
            </li>
          </ul>
        </div>
